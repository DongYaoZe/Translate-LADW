...
在下面的讨论中，$\det A = D(\aaa_1, \aaa_2, \dots, \aaa_n)$ 表示满足上文第 3.1 小节中性质 1–3 的一个函数。
...
\begin{problemset}
\item \label{ex:03-03-01} 如果 $A$ 是一个 $n \times n$ 矩阵，$\det(3A)$ 与 $\det A$ 有何关系？\\
$\det(3A) = 3 \det A$ 仅在 $1 \times 1$ 矩阵的平凡情况下成立。
...
\item \label{ex:03-03-10} 设 $A$ 和 $C$ 是方阵，证明分块三角矩阵
